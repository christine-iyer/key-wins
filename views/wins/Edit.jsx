...
class Edit extends React.Component {
    render(){
        ...
        return (
            <Default title={`${success} Edit Page`} fruit={this.props.win}>
                <form method="POST" action={`/wins/${_id}?_method=PUT`}>
                    success: <input type="text" name="success" defaultValue={success}></input><br/>
                    satisfaction: <input type="checkbox" name="satisfaction" defaultValue={satisfaction}></input><br />
                    challenge: <input type="checkbox" name="challenge" defaultValue={challenge}></input><br/>
                    ...
                    gratitude: <input type="checkbox" name="gratitude" defaultValue={gratitude}></input><br />
